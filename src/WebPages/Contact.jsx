...
export default function Contact() {
  ...
  return (
    <section id="contact" className="pt-10 pb-0 md:pt-32 md:pb-0 relative scroll-reveal overflow-hidden bg-bg-primary">
      ...
      <footer className="border-t border-text-primary/5 bg-white/60 backdrop-blur-md py-12 mt-20 md:mt-28 w-full relative z-10">
        <div className="max-w-7xl mx-auto px-6 md:px-8 flex flex-col sm:flex-row items-center justify-between gap-6 font-sans text-[0.68rem]">
          <p className="text-text-muted font-bold tracking-wider">COPYRIGHT &copy; {new Date().getFullYear()} PORTFOLIO.PIYUSHLANDGE. ALL RIGHTS RESERVED.</p>
